 ...
 *
 * @package Aerospace_Menu_Item_Custom_Fields
 * @version 1.0
 * @author Dzikri Aziz <kvcrvt@gmail.com>
 *
 *
 * Plugin name: Aerospace Custom Menu Fields
 ...
 * @since 0.1.0
 */
class Aerospace_Menu_Item_Custom_Fields {
	 ...
	 * @var    array
	 * @access protected
	 * @since  Aerospace_Menu_Item_Custom_Fields 0.2.0
	 */
	...
	public static function init() {
		...
		self::$fields = array(
			'menu_post_type' => __( 'Post Type', 'menu-item-custom-fields-example' ),
			'menu_featured_post_description' => __( 'Featured Post Description', 'menu-item-custom-fields-example' ),
		);
	}
...
Aerospace_Menu_Item_Custom_Fields::init();