    ...
    <footer id="colophon" class="site-footer">
        <div class="site-info content-wrapper row">
            <div class="footer-logo col-xs-12">
                <a href="https://www.csis.org" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/CSIS-footer-logo.svg" alt="Center for Strategic and International Studies" title="Center for Strategic and International Studies" /></a>
            </div>
            <div class="footer-info col-xs-12 col-md-8">
                ...
                <ul class="footer-social">
                    <?php
                    if ( $twitter ) {
                        echo '<li><a href="https://twitter.com/' . esc_attr( $twitter ) . '" target="_blank"><i class="icon-twitter"></i>@' . esc_attr( $twitter ) . '</a></li>';
                    }
                    if ( $email ) {
